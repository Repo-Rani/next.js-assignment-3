...
export const SKILLS: SkillsTypes[] = [
  {
    ...
    skills: [
      ...
      { Skills: "CSS3", percentage: "75%" },
      { Skills: "Javascript", percentage: "70%" },
      { Skills: "Typescrpt", percentage: "75%" },
    ],
  },
  {
    title: "Backend",
  ...
  },
  {
    ...
    skills: [
      ...
      { Skills: "Figma", percentage: "75%" },
      { Skills: "UI/UX Design ", percentage: "60%" },
    ],
  },
  {
    title: "Interpersonal Skills ",
    icon: "/interpersonal_skills.png",
    skills: [
      { Skills: "Problem-solving", percentage: "65%" },
      { Skills: "Collabration", percentage: "75%" },
      { Skills: "Attention", percentage: "75%" },
    ],
  },
];
